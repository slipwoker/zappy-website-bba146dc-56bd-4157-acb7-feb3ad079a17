document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      contactForm.dispatchEvent(new CustomEvent('formValidated', { bubbles: true, detail: { form: contactForm } }));
    });
  }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מופיעים בספק משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bba146dc-56bd-4157-acb7-feb3ad079a17',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bba146dc-56bd-4157-acb7-feb3ad079a17';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bba146dc-56bd-4157-acb7-feb3ad079a17';
